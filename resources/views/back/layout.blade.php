...
<html>
    <head>
        ...
        <!-- my style.css -->
        <link rel="stylesheet" href="{{ asset('public/AdminLTE/css/style.css')}}">
...
<div class="wrapper">
    ...
    <header class="main-header">
        <a href="{{ route('dashboard')}}" class="logo">
            <span class="logo-mini"><b>102</b></span>
            <span class="logo-lg">102-MTM</span>
        </a>
            ...
            @endif
                ...
                <li>
                    <a href="{{ route('employees.index')}}">
                        <i class="fa fa-briefcase"></i> <span>Hodimlar | Employees</span>
                    </a>
                </li>
            @if (Auth::user()->role == 'redac' || Auth::user()->role == 'admin')
                <li>
                    <a href="{{ route('employees.create')}}">
                        <i class="fa fa-plus"></i> <span>Hodim Qo`shish</span>
                    </a>
                </li>
            @endif
                <hr>
                <li>
                    <a href="{{ route('sliders.index')}}">
                        <i class="fa fa-object-group"></i> <span>Slayder | Slider</span>
                    </a>
                </li>
            @if (Auth::user()->role == 'redac' || Auth::user()->role == 'admin')
                <li>
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2019 <a href="#">102-MTM</a>.</strong> All rights reserved.
    </footer>
