...
$(function () {
    $(".carousel-buttons").on("click", function () {
        let buttons = $('.carousel-buttons');
        buttons.hide();
        setTimeout(function () {
            buttons.show();
        }, 600);
...
if (window.location.toString().indexOf('news') != -1) {
    ...
    var url = './galleries/';
} else if (window.location.toString().indexOf('sliders') != -1) {
    var url = './sliders/';
} else if (window.location.toString().indexOf('employees') != -1) {
    var url = './employees/';
